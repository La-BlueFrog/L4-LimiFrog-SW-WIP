...
Preliminary Note:
LimiFrog used to be called La BlueFrog before a recent name change.
Due to time constraints, this name change has not yet been reflected everywhere in the documentation.
	...
	-- /projects
		...
		-- /STARTUP
			-- startup_stm32l476xx.s
					  ...
					  # STM32L4-specific  -  supplied by ST
